...
public class BinarySearchMissing {
    ...
    public static void main(String[] args) {
        ...
        // || (arr.length == 0 => ansIterative == 0)
        // || (forall i=(0..arr.length): arr[i] != x => x < arr[ansIterative - 1] && ans[ansIterative] < x)
        // || (i form (0..arr.length): arr[i] == x => arr[ansIterative] == x && arr[ansIterative - 1] > x)
        ...
        // || (forall i=(0..arr.length): arr[i] != x => x < arr[ansRecursive - 1] && ans[ansRecursive] < x)
        // || (i form (0..arr.length): arr[i] == x => arr[ansRecursive] == x && arr[ansRecursive - 1] > x)

        int ans = ansIterative;
        //int ans = ansRecursive;
